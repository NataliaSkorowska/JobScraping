...
| WF4  | Funkcjonalne  | Obsługa błędów | Dedykowana strona błedu | Jeśli użytkownik będzie próbował przejść na zasoby serweru, które nie są dla niego dostępne lub, które nie istnieją zostanie wyświetlona dedykowana strona do obsługi błędu informująca użytkownika o błędzie  | P2
